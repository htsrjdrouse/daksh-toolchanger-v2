...
## NUDGE_MOVE_OVER_PROBE ##
This macro is where you put the nudge location. Eventually it would be good to this into the variables.cfg
...
This calls the python script tools_calibrate.py (located in klipper/klippy/extras/) 
...
class ToolsCalibrate:
    ...
    def cmd_TOOL_CALIBRATE_SAVE_TOOL_OFFSET(self, gcmd):
        ...
        save_variables.cmd_SAVE_VARIABLE(self.gcode.create_gcode_command("SAVE_VARIABLE", "SAVE_VARIABLE", {"VARIABLE": param_name, 'VALUE': value }))
